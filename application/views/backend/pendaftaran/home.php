    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h5 class="page-title">List Pendaftaran</h5>
            </div>
        </div>
        <!-- end row -->
                ...
                <div class="card m-b-30">
                    <div class="p-3">
                        <div class="mini-stat-icon">
                            <a href="<?php echo base_url('admin/pendaftaran/add') ?>" class="btn btn-primary float-right">Tambah</a>
                        </div>
                        <h6 class="text-uppercase">List Jadwal Pendaftaran PSB Online</h6>
                    </div>
...
<script>
    $(document).ready(function() {
        var table = $('#datatable').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<?php echo site_url('admin/pendaftaran/data_json') ?>",
            "bAutoWidth": false,
            "bPaginate": true,
            "iDisplayLength": "10",
            "bLengthChange": true,
