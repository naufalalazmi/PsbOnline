    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h5 class="page-title">List Pengguna Admin</h5>
            </div>
        </div>
        <!-- end row -->
                ...
                <div class="card m-b-30">
                    <div class="p-3">
                        <div class="mini-stat-icon">
                            <a href="<?php echo base_url('admin/user/add/admin')?>" class="btn btn-primary float-right">Tambah</a>
                        </div>
                        <h6 class="text-uppercase">List Pengguna Admin</h6>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('admin/user/data_admin')?>",
        "bAutoWidth": false,
        "bPaginate": true,
        "iDisplayLength": "10",
        "bLengthChange": true,
        ...
        "aoColumnDefs": [
            ...
            { "sWidth": "125", "sClass": "medium", "aTargets": [ 1 ] },
            { "sWidth": "125", "sClass": "medium", "aTargets": [ 2 ] },
            { "sWidth": "125", "sClass": "medium", "aTargets": [ 3 ] },
            { "sWidth": "5", "sClass": "text-center", "aTargets": [ 4 ] }
        ]
    });
